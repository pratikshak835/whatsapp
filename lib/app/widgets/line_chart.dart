...
class CustomLineChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const CustomText(
          text: "Category Wise - Sales Breakdown",
          color: Colors.black,
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    // switch (value.toInt()) {
    //   case 2:
    //     text = const Text('SUNGLASSES', style: style);
    //     break;
    //   case 7:
    //     text = const Text('SHOES', style: style);
    //     break;
    //   case 12:
    //     text = const Text('WATCHES', style: style);
    //     break;
    //   default:
    //     text = const Text('');
    //     break;
